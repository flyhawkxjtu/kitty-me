  ...
  <div class="page-container">
    <div class="search_div">
      <el-row type="flex" align="middle" style="margin-top: 10px;height: 50px">
        ...
        <el-col :span="4">
          <kt-button icon="fa fa-search" :label="$t('action.search')" perms="sys:menu:view" type="danger" @click="findTreeData(null)"/>
    ...
    <div class="table_div">
      <el-row type="flex" align="middle" style="height: 50px">
        <el-col :span="6" style="text-align: left;margin-left: 20px">
          <kt-button icon="fa fa-plus" :label="$t('action.add')" perms="sys:dept:add" type="danger" @click="handleAdd" />
