  ...
  <div class="page-container">
    ...
    <div class="search_div">
      <el-row type="flex" align="middle" style="margin-top: 10px;height: 50px">
        ...
        <el-col :span="4">
          <kt-button icon="fa fa-search" :label="$t('action.search')" perms="sys:role:view" type="danger" @click="findPage(null)"/>
    ...
    <div class="table_div">
      <el-row type="flex" align="middle" style="height: 50px">
        <el-col :span="6" style="text-align: left;margin-left: 20px">
          <kt-button icon="fa fa-plus" :label="$t('action.add')" perms="sys:role:add" type="danger" @click="handleAdd" />
	...
	<!--角色菜单，表格树内容栏-->
	<div class="menu-container" v-if="roleTree">
		...
		<div style="float:right;padding-right:15px;padding-top:4px;padding-bottom:4px;">
			<kt-button :label="$t('action.reset')" perms="sys:role:edit"  @click="resetSelection"
				:disabled="this.selectRole.id == null"/>
			<kt-button :label="$t('action.submit')" perms="sys:role:edit" type="danger" @click="submitAuthForm"
		...
		renderContent(h, { node, data, store }) {
			return (
				...
				<el-row>
					...
					<el-col span="4">
						<div class="grid-content bg-purple">
							<span  >{data.parentName?data.parentName:'顶级菜单'}</span>
						</div>
					</el-col>
					<el-col span="8">
						<div class="grid-content bg-purple">
