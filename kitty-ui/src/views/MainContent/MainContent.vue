...
export default {
  ...
  computed: {
    ...
    isClosable(){
      return this.mainTabsActiveName !== '首页'
    }
  },
  methods: {
    // tabs, 选中tab
...
<style>
  #tab-首页 .el-icon-close{
    display: none;
  }
  .main-container .el-tabs__item:hover{
    color: #42464a;
  }
  .main-container .el-tabs__item.is-active{
    color: #303133;
    background-color:#EDF0F5;
    border-bottom:0;
  }
  .main-container .el-tabs--card>.el-tabs__header .el-tabs__item.is-active{
