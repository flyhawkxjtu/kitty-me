    ...
    <el-form-item >
      <el-col :span="12">
        <el-form-item prop="captcha">
          <el-input type="test" v-model="loginForm.captcha" auto-complete="off" @keyup.enter.native="login" placeholder="验证码, 单击图片刷新"
            style="width: 100%;">
          </el-input>
        </el-form-item>
      </el-col>
    ...
    login() {
      ...
      this.$api.login.login(userInfo).then((res) => {
          if(res.msg != null) {
            ...
            sessionStorage.setItem('user.name', res.data.chineseName) // 保存用户姓名到本地会话
