<template>
  <div class="kt_table">
    ...
    <el-table :data="data.content" :highlight-current-row="highlightCurrentRow" @selection-change="selectionChange"
          ...
          :show-overflow-tooltip="showOverflowTooltip" :max-height="maxHeight" :size="size" :align="align" style="width: 97%;margin: 0 auto;" >
    ...
    <el-row type="flex" align="middle" style="height: 50px" justify="end">
      <el-pagination layout="total,prev, pager, next, sizes, jumper" @size-change="handleSizeChange" @current-change="refreshPageRequest" background
                     :current-page="pageRequest.pageNum" :page-sizes="[10,20,50,100]" :page-size="pageRequest.pageSize" :total="data.totalSize" style="margin-top: 15px;margin-right:15px">
      </el-pagination>
    </el-row>
...
<style>
  .kt_table .el-pagination.is-background .el-pager li:not(.disabled).active{
    background-color: #F14040;
  }
  .kt_table .el-pagination.is-background .btn-next, .el-pagination.is-background .btn-prev, .el-pagination.is-background .el-pager li{
