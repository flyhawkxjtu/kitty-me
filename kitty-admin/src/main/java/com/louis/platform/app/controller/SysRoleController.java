...
import com.louis.platform.app.sevice.SysRoleService;
...
public class SysRoleController {
	...
	public HttpResult save(@RequestBody SysRole record) {
		...
		if(role != null) {
			if(PlatformConstant.ADMIN.equalsIgnoreCase(role.getName())) {
	...
	public HttpResult saveRoleMenus(@RequestBody List<SysRoleMenu> records) {
		for(SysRoleMenu record:records) {
			...
			if(PlatformConstant.ADMIN.equalsIgnoreCase(sysRole.getName())) {
				// 如果是超级管理员，不允许修改
